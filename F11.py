...
def riwayatpinjam(datas4, header4): # F11 - Melihat riwayat peminjaman gadget
  array_date = []
  ...
  a = 0
  b = len(datas_sorted)
  def output_sort(a, b, data_by_date): # Print data yang telah diurutkan berdasarkan tanggal
    if (b-a) <= 4:
      for i in range(a,b):
